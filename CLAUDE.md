...
- ロードマップ（機能実装、実装完走済・archive 済）: `plans/archive/board-roadmap.md`
...
- マイルストーン詳細:
  - 進行中: `plans/board-phase-k-m{NN}-{slug}.md`
  - 準拠検証: `plans/board-compliance-m{NN}-{slug}.md`
  - 完走済（archive）: `plans/archive/board-m{NN}-{slug}.md`
