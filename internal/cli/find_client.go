...
func NewFindClientCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long:  "Search for clients by ID, name. Returns clients with their associated branches and contacts.",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return output.Write(os.Stdout, wrapFindOutput(cmd.Context(), "client", results), prettyFromCmd(cmd))
		},
	}
