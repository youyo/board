...
func makePaymentRepo(t *testing.T, db *cache.DB, apiClient *boardapi.Client) *repository.PaymentRepository {
	t.Helper()
	...
	return repository.NewPaymentRepository("default", apiClient, rc, ss, refresher, lm, time.UTC)
}
