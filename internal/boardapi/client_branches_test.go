...
func TestListClientBranchesRaw_SinglePage(t *testing.T) {
	...
	raw, err := client.ListClientBranchesRaw(context.Background())
	if err != nil {
...
func TestListClientBranchesRaw_MultiPage(t *testing.T) {
	...
	raw, err := client.ListClientBranchesRaw(context.Background(), boardapi.WithPerPage(2))
	if err != nil {
		t.Fatalf("ListClientBranchesRaw: %v", err)
	}
	if pageCount != 2 {
...
func TestGetClientBranchRaw_Success(t *testing.T) {
	...
	raw, err := client.GetClientBranchRaw(context.Background(), 42)
	if err != nil {
...
func TestGetClientBranchRaw_NotFound(t *testing.T) {
	...
	_, err := client.GetClientBranchRaw(context.Background(), 99)
	if err == nil {
...
func TestSearchClientBranchesRaw_QueryParams(t *testing.T) {
	...
	raw, err := client.SearchClientBranchesRaw(context.Background(), boardapi.ClientBranchSearchParams{
		ClientID: 123,
		Name:     "keyword",
	})
	if err != nil {
